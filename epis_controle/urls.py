...
from home.views import home, cadastrar_colaborador, editar_colaborador, excluir_colaborador, relatorio, cadastrar_equipamento, editar_equipamento, excluir_equipamento
